...
#define VERSION_INTERNAL_BUILD		12  // Build day

#define VERSION_STRING				"Day-12,Month-04,Year-26,BuildNum-04" // build date
#define VERSION_STRING_DOTTED		"Day-12,Month-04,Year-26,BuildNum-04" // build date
