...
#define VERSION_INTERNAL_BUILD		15  // Build day

#define VERSION_STRING				"Day-15,Month-04,Year-26,BuildNum-06" // build date
#define VERSION_STRING_DOTTED		"Day-15,Month-04,Year-26,BuildNum-06" // build date
