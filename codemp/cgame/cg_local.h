...
typedef struct cgMedia_s {
	...
	sfxHandle_t	saberBounce1;
	sfxHandle_t	saberBounce2;
...
typedef struct cgEffects_s {
	...
	// SBD PISTOL
	fxHandle_t	sbdShotEffect;
	fxHandle_t	sbdPowerupShotEffect;
	fxHandle_t	sbdWallImpactEffect;
	fxHandle_t	sbdWallImpactEffect2;
	fxHandle_t	sbdWallImpactEffect3;
	fxHandle_t	sbdFleshImpactEffect;
	fxHandle_t	sbdDroidImpactEffect;
	...
	fxHandle_t  ewebWallImpactEffect;
	fxHandle_t  ewebFleshImpactEffect;
	fxHandle_t  ewebDroidImpactEffect;
	...
	fxHandle_t	flechetteAltBlowEffect;
	...
	fxHandle_t	mSaberprfectBlock;
	fxHandle_t	mSpawn;
	fxHandle_t	mJediSpawn;
	fxHandle_t	mBlasterDeflect;
	fxHandle_t	mBlasterDeflectpassthrough;
...
typedef struct cgs_s {
	...
	//
	qhandle_t		game_models[MAX_MODELS];
...
extern vmCvar_t team_sabercolours;
