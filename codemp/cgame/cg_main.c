...
static void C_G2Mark(void)
{
	const TCGG2Mark* td = &cg.sharedBuffer.g2Mark;
	trace_t tr;
	vec3_t end;
...
static void C_ImpactMark(void)
{
	const TCGImpactMark* data = &cg.sharedBuffer.impactMark;
...
static void CG_AS_Register(void)
{
	...
	for (int i = 1; i < MAX_AMBIENT_SETS; i++)
	{
...
static void CG_RegisterSounds(void)
{
	...
	cgs.media.unstableBlurShader = trap->R_RegisterShader("gfx/effects/TFASabers/trail_unstable");
	cgs.media.swordTrailShader = trap->R_RegisterShader("gfx/effects/sabers/swordTrail");
	cgs.media.sfxSaberTrailShader = trap->R_RegisterShader("gfx/effects/sabers/saber_trail");
	cgs.media.sfxSaberBladeShader = trap->R_RegisterShader("gfx/effects/sabers/saber_blade");
	cgs.media.sfxSaberBlade2Shader = trap->R_RegisterShader("gfx/effects/sabers/saber_blade_rgb");
	cgs.media.sfxSaberEndShader = trap->R_RegisterShader("gfx/effects/sabers/saber_end");
	cgs.media.sfxSaberEnd2Shader = trap->R_RegisterShader("gfx/effects/sabers/saber_end_rgb");
	...
	cgs.media.blueIgniteFlare = trap->R_RegisterShader("gfx/effects/sabers/blue_ignite_flare");
	cgs.media.orangeIgniteFlare = trap->R_RegisterShader("gfx/effects/sabers/orange_ignite_flare");
	cgs.media.yellowIgniteFlare = trap->R_RegisterShader("gfx/effects/sabers/yellow_ignite_flare");
	cgs.media.limeSaberGlowShader = trap->R_RegisterShader("gfx/effects/sabers/lime_glow");
	...
	cgs.media.redOTGlowShader = trap->R_RegisterShader("gfx/effects/OTsabers/ot_redGlow");
	cgs.media.orangeOTGlowShader = trap->R_RegisterShader("gfx/effects/OTsabers/ot_orangeGlow");
	cgs.media.yellowOTGlowShader = trap->R_RegisterShader("gfx/effects/OTsabers/ot_yellowGlow");
	cgs.media.greenOTGlowShader = trap->R_RegisterShader("gfx/effects/OTsabers/ot_greenGlow");
	cgs.media.blueOTGlowShader = trap->R_RegisterShader("gfx/effects/OTsabers/ot_blueGlow");
	cgs.media.purpleOTGlowShader = trap->R_RegisterShader("gfx/effects/OTsabers/ot_purpleGlow");
	...
	for (i = 1; i < 5; i++)
	{
		trap->S_RegisterSound(va("sound/weapons/saber/saber_locking_end%d.mp3wav", i));
	}
	for (i = 1; i < 11; i++)
	{
	...
	for (i = 1; i < 90; i++)
	{
		trap->S_RegisterSound(va("sound/weapons/saber/saberblock%i", i));
	}

	for (i = 1; i < 4; i++)
	{
		trap->S_RegisterSound(va("sound/weapons/saber/bounce%i", i));
	}

	for (i = 1; i < 4; i++)
	{
		trap->S_RegisterSound(va("sound/weapons/saber/saber_goodparry%i", i));
	}

	for (i = 1; i < 4; i++)
	{
		trap->S_RegisterSound(va("sound/weapons/saber/saber_perfectblock%i", i));
	}

	for (i = 1; i < 4; i++)
	{
		trap->S_RegisterSound(va("sound/weapons/saber/saberknock%i", i));
	}
	...
	trap->S_RegisterSound("sound/weapons/saber/saberhum2");
	trap->S_RegisterSound("sound/weapons/saber/saberhum3");
	trap->S_RegisterSound("sound/weapons/saber/saberhum4");
	trap->S_RegisterSound("sound/weapons/saber/saberhum5");
	trap->S_RegisterSound("sound/weapons/saber/saberhum6");
	trap->S_RegisterSound("sound/weapons/saber/saberhum7");
	trap->S_RegisterSound("sound/weapons/saber/saberhum8");
	trap->S_RegisterSound("sound/weapons/saber/saberhum9");
	trap->S_RegisterSound("sound/weapons/saber/saberon");
	trap->S_RegisterSound("sound/weapons/saber/saberon1");
	trap->S_RegisterSound("sound/weapons/saber/saberon2");
	trap->S_RegisterSound("sound/weapons/saber/saberon3");
	trap->S_RegisterSound("sound/weapons/saber/saberon4");
	trap->S_RegisterSound("sound/weapons/saber/saberon5");
	trap->S_RegisterSound("sound/weapons/saber/saberon6");
	trap->S_RegisterSound("sound/weapons/saber/saberoff");
	trap->S_RegisterSound("sound/weapons/saber/saberoffquick");
	...
	trap->S_RegisterSound("sound/weapons/saber/saberhit");
	trap->S_RegisterSound("sound/weapons/saber/saberhit1");
	trap->S_RegisterSound("sound/weapons/saber/saberhit2");
	trap->S_RegisterSound("sound/weapons/saber/saberhit3");
	trap->S_RegisterSound("sound/weapons/saber/saberhit4");
	trap->S_RegisterSound("sound/weapons/saber/saberhit5");
	trap->S_RegisterSound("sound/weapons/saber/saberhit6");
	trap->S_RegisterSound("sound/weapons/saber/saberhit7");
	trap->S_RegisterSound("sound/weapons/saber/saberhit8");
	trap->S_RegisterSound("sound/weapons/saber/saberhit9");
	trap->S_RegisterSound("sound/weapons/saber/saberhit10");
	trap->S_RegisterSound("sound/weapons/saber/saberhit11");
	trap->S_RegisterSound("sound/weapons/saber/saberhit12");
	trap->S_RegisterSound("sound/weapons/saber/saberhit13");
	...
	trap->S_RegisterSound("sound/weapons/saber/lightning2");
	trap->S_RegisterSound("sound/weapons/saber/lightning3");
	...
	trap->S_RegisterSound("sound/weapons/force/speed.mp3");
	trap->S_RegisterSound("sound/weapons/force/dash.mp3");
	...
	trap->S_RegisterSound("sound/weapons/force/push.mp3");
	...
	trap->S_RegisterSound("sound/weapons/force/jumpsmall.mp3"); //PDSOUND_FORCEJUMP
	...
	cgs.media.humiliationSound = trap->S_RegisterSound("sound/player/humiliationSound.mp3");
	...
	cgs.media.batteryChargeSound = trap->S_RegisterSound("sound/interface/pickup_battery.wav");

	cgs.media.messageLitSound = trap->S_RegisterSound("sound/interface/update.wav");

	cgs.media.noforceSound = trap->S_RegisterSound("sound/weapons/force/noforce");

	cgs.media.overload = trap->S_RegisterSound("sound/weapons/force/overload");

	cgs.media.overheatgun = trap->S_RegisterSound("sound/vehicles/weapons/imp_blaster/impact.mp3");
	...
	cgs.media.atstWaterInSound[0] = trap->S_RegisterSound("sound/chars/atst/atst_water_in1.wav");
	cgs.media.atstWaterInSound[1] = trap->S_RegisterSound("sound/chars/atst/atst_water_in2.wav");
	cgs.media.atstWaterOutSound[0] = trap->S_RegisterSound("sound/chars/atst/atst_water_out1.wav");
	cgs.media.atstWaterOutSound[1] = trap->S_RegisterSound("sound/chars/atst/atst_water_out2.wav");

	cgs.media.lavaInSound = trap->S_RegisterSound("sound/player/inlava.wav");
	cgs.media.lavaOutSound = trap->S_RegisterSound("sound/player/watr_out.wav");
	cgs.media.lavaUnSound = trap->S_RegisterSound("sound/player/watr_un.wav");
	...
	cgs.media.medkitSound2 = trap->S_RegisterSound("sound/items/use_bacta2.wav");
...
static void CG_RegisterEffects(void)
{
	...
	*/
	...
	cgs.effects.breath = trap->FX_RegisterEffect("misc/breath");
	cgs.effects.breath = trap->FX_RegisterEffect("misc/breathSith");
}
...
static void CG_RegisterGraphics(void)
{
	...
	trap->R_RegisterShaderNoMip("gfx/effects/irid_shield");
	...
	cgs.media.radarScanShader = trap->R_RegisterShaderNoMip("gfx/hud/Radarscanline");
	...
	cgs.effects.mSaberCutMD = trap->FX_RegisterEffect("saber/saber_cut_MD.efx");
	...
	cgs.effects.mBlasterDeflectpassthrough = trap->FX_RegisterEffect("blaster/deflect_passthrough.efx");
	...
	cgs.effects.greenlightningwide = trap->FX_RegisterEffect("force/greenlightningwide");
	cgs.effects.greenlightning = trap->FX_RegisterEffect("force/greenlightning");
	cgs.effects.purplelightningwide = trap->FX_RegisterEffect("force/purplelightningwide");
	cgs.effects.purplelightning = trap->FX_RegisterEffect("force/purplelightning");

	cgs.effects.yellowlightningwide = trap->FX_RegisterEffect("force/yellowlightningwide");
	cgs.effects.yellowlightning = trap->FX_RegisterEffect("force/yellowlightning");
	...
	if (cgs.gametype == GT_CTF || cgs.gametype == GT_CTY || com_buildScript.integer)
	{
		...
		trap->R_RegisterShaderNoMip("gfx/2d/jsense");
		trap->R_RegisterShaderNoMip("gfx/2d/dmgsense");
		trap->R_RegisterShaderNoMip("gfx/2d/cloaksense");
		trap->R_RegisterShaderNoMip("gfx/2d/firesense");
		trap->R_RegisterShaderNoMip("gfx/2d/stasissense");
	...
	cgs.media.useableHint = trap->R_RegisterShader("gfx/hud/useableHint");
	...
	{
		cgs.media.chunkModels[CHUNK_METAL2][i] = trap->R_RegisterModel(va("models/chunks/metal/metal1_%i.md3", i + 1));
		//_ /switched\ _
		cgs.media.chunkModels[CHUNK_METAL1][i] = trap->R_RegisterModel(va("models/chunks/metal/metal2_%i.md3", i + 1));
		//  \switched/
		...
		cgs.media.chunkModels[CHUNK_WHITE_METAL][i] = trap->R_RegisterModel(
	...
	*/
	...
	cgs.media.HUDblockpoint1 = trap->R_RegisterShader("gfx/hud/blockpoint1");
	cgs.media.HUDblockpoint2 = trap->R_RegisterShader("gfx/hud/blockpoint2");

	cgs.media.HUDblockpointMB1 = trap->R_RegisterShader("gfx/hud/blockpointMB1");
	cgs.media.HUDblockpointMB2 = trap->R_RegisterShader("gfx/hud/blockpointMB2");
	...
	int breakPoint = cgs.numInlineModels = trap->CM_NumInlineModels();
	...
	for (i = 1; i < MAX_MODELS; i++)
	{
		...
		const char* cModelName = CG_ConfigString(CS_MODELS + i);
		if (!cModelName[0])
		{
			break;
		}
		...
		if (modelName[0] != '$' && modelName[0] != '@')
		{
			...
			cgs.game_models[i] = trap->R_RegisterModel(modelName);
		}
		else
		{
...
void CG_StartMusic(const qboolean bForceStart)
{
	...
	if (strcmp(parm1, "") == 0 && strcmp(parm2, "") == 0)
	{
		//no music file given, turn off the music
...
void CG_Init(const int serverMessageNum, const int serverCommandSequence, const int clientNum)
{
	...
	cgs.media.weaponProngsOn = trap->R_RegisterShaderNoMip("gfx/hud/prong_on_w");
	cgs.media.weaponProngsOff = trap->R_RegisterShaderNoMip("gfx/hud/prong_off");
	cgs.media.forceProngsOn = trap->R_RegisterShaderNoMip("gfx/hud/prong_on_f");
	...
	//jk2 hud
	cgs.media.JK2HUDLeftFrame = trap->R_RegisterShaderNoMip("gfx/hud/JK2static_test");
	...
	cgs.media.JK2HUDArmor1 = trap->R_RegisterShaderNoMip("gfx/hud/JK2armor1");
	cgs.media.JK2HUDArmor2 = trap->R_RegisterShaderNoMip("gfx/hud/JK2armor2");
	cgs.media.JK2HUDArmorTic = trap->R_RegisterShaderNoMip("gfx/hud/JK2armor_tic");

	cgs.media.JK2HUDHealth = trap->R_RegisterShaderNoMip("gfx/hud/JK2health");
	cgs.media.JK2HUDHealthTic = trap->R_RegisterShaderNoMip("gfx/hud/JK2health_tic");

	cgs.media.JK2HUDSaberStyleFast = trap->R_RegisterShaderNoMip("gfx/hud/JK2saber_stylesFast");
	cgs.media.JK2HUDSaberStyleMed = trap->R_RegisterShaderNoMip("gfx/hud/JK2saber_stylesMed");
	cgs.media.JK2HUDSaberStyleStrong = trap->R_RegisterShaderNoMip("gfx/hud/JK2saber_stylesStrong");
	cgs.media.JK2HUDSaberStyleDesann = trap->R_RegisterShaderNoMip("gfx/hud/JK2saber_stylesDesann");
	cgs.media.JK2HUDSaberStyleTavion = trap->R_RegisterShaderNoMip("gfx/hud/JK2saber_stylesTavion");
	cgs.media.JK2HUDSaberStyleStaff = trap->R_RegisterShaderNoMip("gfx/hud/JK2saber_stylesStaff");
	cgs.media.JK2HUDSaberStyleDuels = trap->R_RegisterShaderNoMip("gfx/hud/JK2saber_stylesDuals");

	cgs.media.messageLitOn = trap->R_RegisterShaderNoMip("gfx/hud/message_on");
	...
	{
		JK2forceTicPos[i].tic = trap->R_RegisterShaderNoMip(JK2forceTicPos[i].file);
		JK2ammoTicPos[i].tic = trap->R_RegisterShaderNoMip(JK2ammoTicPos[i].file);
	}
...
{
	const autoMapInput_t* autoInput = &cg.sharedBuffer.autoMapInput;
	...
	intptr_t arg5, intptr_t arg6, intptr_t arg7, intptr_t arg8, intptr_t arg9, intptr_t arg10, intptr_t arg11)
{
	...
	case CG_GET_MODEL_LIST:
		return (intptr_t)cgs.game_models;
